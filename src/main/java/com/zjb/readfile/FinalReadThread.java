...
public class FinalReadThread extends Thread{
    ...
    public FinalReadThread(long start, long end, RandomAccessFile raf,RandomAccessFile raf_w,CountDownLatch doneSignal,String randomN){
        this.start = start;
        this.end = end;
        this.raf  = raf;
    ...
    public void run(){
        try {
            ...
            for (int i = 0; i < times; i++) {
                ...
                buff = sm4.doFinalDecrypt_ecb(buff);
